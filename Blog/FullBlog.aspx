<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FullBlog.aspx.cs" Inherits="Blog.FullBlog" %>
    ...
    <div class="container">
       <div class="row">
        <div class="fullblog ">
            ...
            <div id="comments" >
                ...
                <div id="newComment">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="yourName" ErrorMessage="Bạn phải nhập tên đi chứ" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                    <br />
                    <label for="yourComment">Your Comment</label>
                    <br />
                    <textarea id="yourComment" runat="server" rows="5" cols="100"></textarea>
                    <br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="yourComment" ErrorMessage="Nhập dữ liệu đê" ForeColor="Red" ></asp:RequiredFieldValidator>
        ...
        <div class="fullblog__sidebar">
            <div class="fullblog__subcribe">
                <p>Get access to the latest tools, freebies, product announcements, and much more!</p>
                 <div class="signup__group">
                     <i class="fas fa-envelope"></i>
                     <input type="text" name="txtSubcribe" placeholder="Your email.." value="" class="fullblog__input" />
                  </div>
                <button class="btn button__sub">Subcribe</button>
                <p><span>Join over 6.000 subcribers</span></p>
            </div> 
            ...
            <a class="fullblog__sideimage" href="#">
                <img src="Images/sideimage.png" alt="Alternate Text" />
                <h3>The Best <br /> Place To Live <br />And Blog</h3>
            </a>
         </div>
        </div>
     </div>
