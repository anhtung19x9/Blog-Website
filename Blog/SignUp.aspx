<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="Blog.SignUp" %>
    ...
    <div class="signup clearfix">
        <div class="signup__left">
           ...
           <div class="signup__group">
            ...
            <div>
                <input type="checkbox" runat="server" id="check" /> <label for="check">Chấp nhập điều khoản</label>

            </div>
         
            <div class="signup__block">
                <asp:Button ID="btn123" runat="server" Text="Register" OnClick="Button1_Click" CssClass="btnSign"/>
            </div> 
        </div>
        <div class="signup__right">
            <div class="signup__image">
                <img src="Images/girl-chat.png" alt="Đây là ảnh blog" />
            </div>
            <a href="SignIn.aspx">I am already member</a>
        </div>
    </div>
    </div>
</asp:Content>
